...
public interface I_AD_System 
{
    ...
    /** Column name SIPContext */
    public static final String COLUMNNAME_SIPContext = "SIPContext";
    ...
    /** Column name SIPHost */
    public static final String COLUMNNAME_SIPHost = "SIPHost";
    ...
    public static final String COLUMNNAME_SIPPassword = "SIPPassword";
    ...
    /** Column name SIPUser */
    public static final String COLUMNNAME_SIPUser = "SIPUser";
