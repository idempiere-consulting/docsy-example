...
// E
	...
	/** Set SIP Context.
		@param SIPContext SIP Context	  */
	public void setSIPContext (String SIPContext)
	{
		set_Value (COLUMNNAME_SIPContext, SIPContext);
	}

	/** Get SIP Context.
		@return SIP Context	  */
	public String getSIPContext () 
	{
		return (String)get_Value(COLUMNNAME_SIPContext);
	}

	/** Set SIP Host.
		@param SIPHost SIP Host	  */
	public void setSIPHost (String SIPHost)
	{
		set_Value (COLUMNNAME_SIPHost, SIPHost);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_SIPHost);
	}
	...
	{
		set_Value (COLUMNNAME_SIPPassword, SIPPassword);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_SIPPassword);
	}

	/** Set SIP User.
		@param SIPUser SIP User	  */
	public void setSIPUser (String SIPUser)
	{
		set_Value (COLUMNNAME_SIPUser, SIPUser);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_SIPUser);
	}
