...
[Sequenza Documento [SDOC00]]({{< ref "_index.it.md#SDOC00" >}} "Sequenza Documento") <br>
[Addebiti [ADD00]]({{< ref "_index.it.md#ADD00" >}} "Addebiti") <br>
[Schema contabile [SC00]]({{< ref "_index.it.md#SC00" >}} "Schema contabile") <br>
[Tipo Addebito [TAD00]]({{< ref "_index.it.md#TAD00" >}} "Tipo Addebito") <br>
[Genera File Instrastat [GFI00]]({{< ref "_index.it.md#GFI00" >}} "Genera File Instrastat") <br>

## Prima Nota [PRNA00] {#PRNA00}
...
# Scritture di integrazione per note di accredito ricevute da fornitori nel nuovo esercizio di competenza dell'esercizio in chiusura.
...
E' un ulteriore costo annuo che la ditta preponente deve accantonare in data 31/12/ap e che si calcola in base alle aliquote (per scaglioni) e tipologia di agente (monomandatario o plurimandatario). Detto importo sarà versato entro il 31/03/ac. La scrittura è la seguente:
...
## Gerarchia dei Report [GDR00] {#GDR00}

[{{< figure src="/image/GerarchiaDeiReport.png"  width="850"  >}}](/image/GerarchiaDeiReport.png)
## Inserimento Colonna Report [ICR00] {#ICR00}
La Maschera permette l'inserimento della colonna del Report.
[{{< figure src="/image/InserimentoColonnaReport.png"  width="850"  >}}](/image/InserimentoColonnaReport.png)
## Esegui Ricalcolo Cubo dei Report [ERCR00] {#ERCR00}
Il Processo permette il ricalcolo del Cubo del Report.
[{{< figure src="/image/EseguiRicalcoloCuboDeiReport.png"  width="850"  >}}](/image/EseguiRicalcoloCuboDeiReport.png)
## Cubo Report [CR00] {#CR00}
La Maschera permette l'inserimento di un 
[{{< figure src="/image/CuboReport.png"  width="850"  >}}](/image/CuboReport.png)
## Inserimento Linea del Report [ILDR00] {#ILDR00}
[{{< figure src="/image/InserimentoLineaDelReport.png"  width="850"  >}}](/image/InserimentoLineaDelReport.png)

## Impostazioni Contabilità
## Azzeramento Contabilità [AZC00] {#AZC00}
[{{< figure src="/image/AzzeramentoContabilita.png"  width="850"  >}}](/image/AzzeramentoContabilita.png)
## Categoria Imposta (Multi-Org) [CAIM01] {#CAIM01}
[{{< figure src="/image/CategoriaImposteMultiOrg.png"  width="850"  >}}](/image/CategoriaImposteMultiOrg.png)
## Gruppo IVA Multi Org [GIMO01] {#GIMO01}
[{{< figure src="/image/GruppoIVAMultiOrg.png"  width="850"  >}}](/image/GruppoIVAMultiOrg.png)
## Contatore Documento [CDOC00] {#CDOC00}
[{{< figure src="/image/ContatoreDocumento.png"  width="850"  >}}](/image/ContatoreDocumento.png)
## Categoria Contabile [CAC00] {#CAC00} 
[{{< figure src="/image/CategoriaContabile.png"  width="850"  >}}](/image/CategoriaContabile.png)
## Crea Addebiti Contabili [CADD00] {#CADD00}
[{{< figure src="/image/CreaAddebitiContabili.png"  width="850"  >}}](/image/CreaAddebitiContabili.png)
## Verifica Tipi Documenti [VTD00] {#VTD00}
[{{< figure src="/image/VerificaTipiDocumenti.png"  width="850"  >}}](/image/VerificaTipiDocumenti.png)
## Dimensioni Contabili [DC00] {#DC00}
[{{< figure src="/image/DimensioniContabili.png"  width="850"  >}}](/image/DimensioniContabili.png)
## Ri/Calcola Imposte Fattura [RCIF00] {#RCIF00}
[{{< figure src="/image/RiCalcolaImpostaFattura.png"  width="850"  >}}](/image/RiCalcolaImpostaFattura.png)
## Piano dei Conti [PDC00] {#PDC00}
[{{< figure src="/image/PianodeiConti.png"  width="850"  >}}](/image/PianodeiConti.png)
## Causale Contabile [CAU17] {#CAU17}
[{{< figure src="/image/CausaleContabile.png"  width="850"  >}}](/image/CausaleContabile.png)
## Rielabora Registrazioni [RIR00] {#RIR00}
[{{< figure src="/image/RielaboraRegistrazioni.png"  width="850"  >}}](/image/RielaboraRegistrazioni.png)
## Tipo Documento [TDOC00] {#TDOC00}
[{{< figure src="/image/TipoDocumento.png"  width="850"  >}}](/image/TipoDocumento.png)
## Aliquota d'Imposta [ADI0] {#ADI0}
[{{< figure src="/image/AliquotaDImposta.png"  width="850"  >}}](/image/AliquotaDImposta.png)
## Configurazione imposte [CI00] {#CI00}
[{{< figure src="/image/ConfigurazioneImposta.png"  width="850"  >}}](/image/ConfigurazioneImposta.png)
## Configurazione Contabilità [CC00] {#CI00}
[{{< figure src="/image/ConfigurazioneContabilita.png"  width="850"  >}}](/image/ConfigurazioneContabilita.png)
## Valuta [VAL00] {#VAL00}
[{{< figure src="/image/Valuta.png"  width="850"  >}}](/image/Valuta.png)
## Combinazione Conto [CMC00] {#CMC00}
[{{< figure src="/image/CombinazioneConto.png"  width="850"  >}}](/image/CombinazioneConto.png)
## Tipo Cambio Valuta [TCV00] {#TCV00}
[{{< figure src="/image/TipoCambioValuta.png"  width="850"  >}}](/image/TipoCambioValuta.png)
## Periodo Contabile [PC00] {#PC00}
[{{< figure src="/image/PeriodoContabile.png"  width="850"  >}}](/image/PeriodoContabile.png)
## Attività (ABC) [AABC00] {#AABC00}
[{{< figure src="/image/AttivitaABC.png"  width="850"  >}}](/image/AttivitaABC.png)
## Categorie imposte [CAI00] {#CAI00}
[{{< figure src="/image/CategorieImposte.png"  width="850"  >}}](/image/CategorieImposte.png)
## Sequenza Documento [SDOC00] {#SDOC00}
[{{< figure src="/image/SequenzaDocumento.png"  width="850"  >}}](/image/SequenzaDocumento.png)
## Addebiti [ADD00] {#ADD00} 
[{{< figure src="/image/Addebiti.png"  width="850"  >}}](/image/Addebiti.png)
## Schema contabile [SC00] {#SC00}
[{{< figure src="/image/SchemaContabile.png"  width="850"  >}}](/image/SchemaContabile.png)
## Tipo Addebito [TAD00] {#TAD00}
[{{< figure src="/image/TipoAddebito.png"  width="850"  >}}](/image/TipoAddebito.png)
## Genera File Instrastat [GFI00] {#GFI00}         
